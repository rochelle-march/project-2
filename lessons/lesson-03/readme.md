...
Review Prior Lesson Content & Exit Tickets. Discuss Current Objectives.

## This Class
Slides are [here](./assets/slides/03-statistics-fundamentals.pdf)
...
Review "Part 1. Basic Stats" of the [starter-code](./code/starter-code/starter-code-3.ipynb).
...
Review "Part 2. Box Plot" of the [starter-code](./code/starter-code/starter-code-3.ipynb).
...
Review "Part 3. SD & Variance" of the [starter-code](./code/starter-code/starter-code-3.ipynb).
...
Lets review [lesson-3-demo](./code/lesson-3-demo.ipynb) for this section. 
